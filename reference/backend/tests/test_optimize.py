"""Tests for the grid/walk-forward optimizer semantics + input overrides +
MAE/MFE excursions.

Moved verbatim from the previous web app (app/api/backtest.py); the module
under test is now algorithms_reference.py — the extracted, FastAPI-free copy
of the same code. Test bodies are untouched."""
...
from algorithms_reference import optimize
...
import algorithms_reference as bt_mod
