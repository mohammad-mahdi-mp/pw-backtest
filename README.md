...
| 3     | Replay / manual trading engine  | 🚧 Session API + UI + order placement; bar-by-bar broker fills next |
...
5. **New Replay** — creates a replay session; Next-bar / +25 bars buttons advance the cursor (broker fill logic lands next phase).
6. **Order ticket** — BUY/SELL market orders with SL/TP recorded in the replay session.
